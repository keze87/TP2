...
public class AtaqueTest {
	...
	public void test01DanioAtaqueRapido() {
		...
		charmander.recibirEfecto(ataque.atacar(charmander));
		squirtle.recibirEfecto(ataque.atacar(squirtle));
		bulbasaur.recibirEfecto(ataque.atacar(bulbasaur));
		jigglypuff.recibirEfecto(ataque.atacar(jigglypuff));
		chansey.recibirEfecto(ataque.atacar(chansey));
		rattata.recibirEfecto(ataque.atacar(rattata));
